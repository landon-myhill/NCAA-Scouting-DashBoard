...
from core import SEASON_YEAR
from core.config import DRAFT_ELIGIBLE_FILE, DRAFT_OVERRIDES_FILE

YEAR = SEASON_YEAR
OUT_FILE = DRAFT_ELIGIBLE_FILE
OVERRIDES_FILE = DRAFT_OVERRIDES_FILE
